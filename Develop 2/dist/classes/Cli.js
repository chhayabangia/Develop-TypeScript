...
class Cli {
    ...
    createMotorbike() {
        inquirer
            ...
            .then((answers) => {
            const motorbike = new Motorbike(Cli.generateVin(), answers.make, answers.color, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), [new Wheel(parseInt(answers.frontWheelDiameter), answers.frontWheelBrand),
    ...
    findVehicleToTow(truck) {
        inquirer
            ...
            if (vehicleToTow.vin === truck.vin) {
                ...
                if (truck.towingCapacity > 0) {
                    console.log(`Towing vehicle: ${vehicleToTow.vin} -- ${vehicleToTow.make} ${vehicleToTow.model}`);
                }
                else {
                    console.log(`This truck cannot tow any vehicles.`);
                }
            }
            this.performActions();
        ...
        inquirer
            ...
            if (answers.action === 'Print details') {
                ...
                if (selectedMotorbike) {
                    ...
                    this.performActions(); // return to actions menu
                }
                else {
